...
<div class="scroll-x nowrap"><table>
  ...
  <tbody>
    <tr>
      ...
      <td>T1</td>
      <td>—</td>
      <td>Research Complexes, Assist Research</td>
      <td>연구소·조교 운용, 기초 연구 속도</td>
      <td>Vanilla</td>
    </tr>
    <tr>
      ...
      <td>T2~T3</td>
      <td>Research Labs</td>
      <td>Self-Evolving Logic</td>
      <td>연구속도 보정·과학선 보조</td>
      <td>Vanilla</td>
    </tr>
    <tr>
      ...
      <td>T2~T4</td>
      <td>Labs/AI</td>
      <td>Codebreaking / Counterintelligence</td>
      <td>정보전·첩보·관측 보정</td>
    ...
    <tr>
      ...
      <td>T1~T4</td>
      <td>—</td>
      <td>Hyperlane 최적화·사격 해결도</td>
      <td>함대 시야·사격 정확도·항법</td>
      <td>Vanilla</td>
    </tr>
    <tr>
      ...
      <td>T2~T5</td>
      <td>Sensors/Field</td>
      <td>Cloak Dampeners·Detection</td>
      <td>클로킹 장치·탐지/대응(First Contact)</td>
      <td>DLC</td>
    </tr>
  </tbody>
</table></div>
...
### 1-2) Field Manipulation — 전력·쉴드·클로킹·천체 현상
<div class="scroll-x nowrap"><table>
  <thead>
    <tr>
      <th>Tech</th>
  ...
  <tbody>
    <tr>
      ...
      <td>T1→T4</td>
      <td>단계별 리액터</td>
      <td>Jump Drive·Psionic Drive</td>
      <td>선체 리액터 업그레이드 체계</td>
      <td>Vanilla</td>
    </tr>
    <tr>
      ...
      <td>T1→T4</td>
      <td>기초 전력</td>
      <td>DM Deflectors / Psionic Shields</td>
      <td>방어 유틸리티(재생·경화 보조)</td>
      <td>Vanilla + Event</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Advanced Cloak</td>
      <td>함선/과학선·관측소 클로킹</td>
      <td>DLC</td>
    </tr>
    <tr>
...
### 1-3) Particles — FTL·반중력·무기·리액터 보조
<div class="scroll-x nowrap"><table>
  <thead>
    <tr>
      <th>Tech</th>
...
> 유사 개념: 하이퍼—(Star Wars), 관문/매스 릴레이—(Stargate)/(Mass Effect), 점프—(Battlestar Galactica)/(Homeworld), 워프—(Star Trek), 클로킹—(Star Trek)/(The Expanse) 감쇠.
...
<div class="scroll-x nowrap"><table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Gateway Construction / Giga라인</td>
      <td>거대구조 수리/건설 관문</td>
      <td>DLC</td>
    </tr>
  </tbody>
...
<div class="scroll-x nowrap"><table>
  ...
  <tbody>
    <tr>
      ...
      <td>T1→T4</td>
      <td>—</td>
      <td>Afterburners 상위</td>
      <td>전술 기동성·이탈/탈출 벡터</td>
      <td>Vanilla</td>
    </tr>
    <tr>
...
> 유사 개념: 행성 파괴 슈퍼무기—(Death Star), 초대형 기함—(Babylon 5 Warlock급), 드레드노트—(The Expanse Donnager-class의 상징성).
...
<div class="scroll-x nowrap"><table>
  ...
  <tbody>
    <tr>
      ...
      <td>T2~T4</td>
      <td>함대 운용</td>
      <td>Command Limit·Naval Cap 상향</td>
      <td>지휘·보급 교리</td>
      <td>Vanilla</td>
    </tr>
  </tbody>
...
<div class="scroll-x nowrap"><table>
  ...
  <tbody>
    <tr>
      ...
      <td>Psi Jump Drive</td>
      <td>사이오닉 컴퓨터·의식·점프</td>
      <td>Vanilla</td>
    </tr>
  </tbody>
</table></div>
...
> 유사 개념: 유전자 각본—(Gattaca)/(Altered Carbon), 사이오닉 항해—(Warhammer 40,000 Navigator), 링 네트워크—(The Expanse), 폴드—(Dune).

---

## 4. FTL·바이패스·점프 — 기술 전용 요약표
<div class="scroll-x nowrap"><table>
  <thead>
    <tr>
      <th>Tech</th>
  ...
  <tbody>
    ...
    <tr>
      <td>Gateway Activation → Construction</td>
      <td>Physics</td>
      <td>T4→T5</td>
      <td>Slipstreams + Mega-Eng.</td>
      <td>—</td>
    ...
    <tr>
      <td>Zero-Point Power → Jump Drive</td>
      <td>Phys.</td>
      <td>T4→T5</td>
      <td>Reactor 상위</td>
      <td>Psi Jump</td>
